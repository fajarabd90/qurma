...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    mysqli_query($conn, "UPDATE `siswa` SET lembaga='$lembaga', nama='$nama', kelas='$kelas', jenis_kelamin='$jenis_kelamin', no_hp='$no_hp', alamat='$alamat', tempat_lahir='$tempat_lahir', tanggal_lahir='$tanggal_lahir', ayah='$ayah', ibu='$ibu' WHERE id = $id");
} else {
