...
<head>
    ...
    <title>Presensi Dan Nilai Ghprib-Tajwid | QurMa</title>
...
<body>
    <div class="container">
        ...
        <div class="title">DAFTAR HADIR & PENILAIAN PEMBELAJARAN GHORIB/TAJWID AL-QUR'AN METODE UMMI - <?= $lembaga; ?></div>
            ...
            <table style="margin-bottom: 10px;">
                <thead>
                    <tr class="custom-border">
                        <th colspan="3" style="width: 366px; text-align: center;">Tanggal</th>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td></td>
