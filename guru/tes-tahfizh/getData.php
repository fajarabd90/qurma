...
WHERE siswa.lembaga = '$lembaga' AND kelompok.guru = '$guru' AND (tes.nama LIKE '%$searchTerm%' OR tes.keterangan LIKE '%$searchTerm%') AND tes.kategori = 'Tahfizh' ORDER BY waktu DESC");
?>
