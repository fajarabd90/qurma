    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#teacherFilter2, #kelasFilter2, #bulanFilter2').change(function() {
                ...
                loadData(selectedKelas, selectedBulan, currentSearchTerm);
            });
            ...
            $('#searchInput').keyup(function() {
                ...
                var selectedKelas = $('#kelasFilter2').val();
                var selectedBulan = $('#bulanFilter2').val();
                loadData(selectedKelas, selectedBulan, searchTerm);
            });

            // Initial load of data without specific filters
            loadData();

            function loadData(selectedKelas, selectedBulan, searchTerm) {
                $.ajax({
                    type: 'GET',
                    url: 'getData.php',
                    data: {
                ...
                $('#formEdit').submit(function(e) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            loadData(selectedBulan2, selectedkelas2, searchTerm);
