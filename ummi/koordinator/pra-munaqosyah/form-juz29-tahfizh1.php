...
<head>
    ...
    <title>Cetak Form Juz 29 (Tahfizh 1) Pra Munaqosyah</title>
...
<body>
    <div class="container">
        <div class="title">DAFTAR NILAI HAFALAN JUZ 29 <br> PRA MUNAQOSAH AL-QUR'AN METODE UMMI <br> <?= $lembaga ?></div>
            ...
            <table class="mb-3">
                <thead>
                    <tr class="custom-border" style="background-color: yellow;">
                        ...
                        <th scope="col">Kls</th>
                        <th scope="col" style="width: 8%;">المرسلات</th>
                        <th scope="col" style="width: 8%;">الإنسان</th>
                        <th scope="col" style="width: 8%;">القيامة</th>
                        <th scope="col" style="width: 8%;">المدثر</th>
                        <th scope="col" style="width: 8%;">المزمل</th>
                        <th scope="col" style="width: 8%;">الجن</th>
