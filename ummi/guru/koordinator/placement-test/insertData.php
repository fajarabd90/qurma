...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    foreach ($nama as $key => $value) {
        ...
        $jilid_clean = mysqli_real_escape_string($conn, $jilid[$key]);
        $halaman_clean = mysqli_real_escape_string($conn, $halaman[$key]);
        ...
        $queryCheck = "SELECT COUNT(*) as count FROM placement WHERE nama = '$nama_clean'";
        ...
        $query = "INSERT INTO placement (nama, jilid, halaman, catatan) VALUES ('$nama_clean', '$jilid_clean', '$halaman_clean', '$catatan_clean')";
