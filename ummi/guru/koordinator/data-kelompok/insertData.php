...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    foreach ($nama as $key => $value) {
        ...
        $guru_clean = mysqli_real_escape_string($conn, $guru[$key]);
        ...
        $queryCheck = "SELECT COUNT(*) as count FROM kelompok WHERE nama = '$nama_clean'";
        ...
        $query = "INSERT INTO kelompok (nama, guru) VALUES ('$nama_clean', '$guru_clean')";
