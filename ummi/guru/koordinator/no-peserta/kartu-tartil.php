...
<head>
    ...
    <title>Cetak Kartu Munaqosyah Tartil</title>
    ...
    <style>
        ...
        .nametag {
            ...
            background-image: url('../../assets/img/kartu-tartil.png');
...
<body>
    <div class="nametag-container">
        ...
        WHERE pra_munaqosyah.lembaga = '$lembaga' AND pra_munaqosyah.kategori = 'Tartil' ORDER BY pra_munaqosyah.kelas, nomor.nama ASC";
            ...
            <div class="nametag">
                ...
                <div class="nametag-info">
                    <div style="display: flex; align-items: center;">
                        <img src="../../assets/img/logo.png" alt="" height="43" style="margin-right: 50px; margin-left: 10px; margin-top: -21px">
                        <p style="font-size: 15px; color: #088030; margin-top: 2px;">
                            <?php echo $row['kategori']; ?>
                        </p>
                    </div>
                    <p style="margin-left: 83px; text-align: left; margin-top: 18px;"><?= $row['nomor']; ?></p>
