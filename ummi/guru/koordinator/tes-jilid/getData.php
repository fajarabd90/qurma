...
WHERE siswa.lembaga = '$lembaga' AND (tes.nama LIKE '%$searchTerm%' OR kelompok.guru LIKE '%$searchTerm%' OR tes.keterangan LIKE '%$searchTerm%') AND tes.kategori = 'Tartil' ORDER BY waktu DESC");
?>
