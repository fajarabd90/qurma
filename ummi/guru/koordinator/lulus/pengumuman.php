...
$sql = mysqli_query($conn, "SELECT lulus.id_tes, siswa.lembaga, tes.nama, siswa.kelas, tes.juz, tes.kategori, lulus.keterangan_mun
FROM lulus
...
<head>
    ...
    <title>Cetak Pengumuman Lulus Munaqosyah</title>
