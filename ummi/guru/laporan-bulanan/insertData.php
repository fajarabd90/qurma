...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    foreach ($nama as $key => $value) {
        ...
        $query = "INSERT INTO laporan (nama, bulan, jilid, halaman, ketuntasan_tartil, juz, surat, ketuntasan_tahfizh, catatan, guru) VALUES ('$nama_clean', '$bulan_clean', '$jilid_clean', '$halaman_clean', '$ketuntasan_tartil_clean', '$juz_clean', '$surat_clean', '$ketuntasan_tahfizh_clean', '$catatan_clean', '$guru_clean')";
