        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <h1 class="h1 mb-3" style="margin-top: -10px;">Paket</h1>

                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card flex-fill w-100">
                                <div class="card-header d-flex">
                                    <h5 class="card-title mb-0" style="font-size: 16px;">Daftar Paket</h5>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#editData').modal({
                ...
                var paket = $(event.relatedTarget).closest("tr").find("td:eq(3)").text();
                ...
                <!-- Form edit -->
                    <form method="post" class="updateData" action="updateData.php" id="formEdit">
                        ...
                        <div class="form-floating mb-2">
                            <input type="text" class="form-control" value="${paket}" id="paket" name="paket" required>
                            <label for="paket">Paket</label>
                        </div>

                        <div class="form-floating mb-2">
                            <input type="text" class="form-control" value="${status}" id="status" name="status" required>
                            <label for="status">Status</label>
                        </div>
