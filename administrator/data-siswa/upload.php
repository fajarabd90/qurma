                        ...
                        <div class="col-xl-12">
                            <div class="card flex-fill w-100">
                                <div class="card-header d-flex">
                                    <h5 class="card-title mb-0" style="font-size: 16px;">Upload Data Siswa</h5>
                        ...
                        <tr>
                            ...
                            <th scope='col'>No. Peserta</th>
                                            ...
                                            foreach ($sheet as $row) { // Lakukan perulangan dari data yang ada di excel
                                                ...
                                                if ($lembaga == "" && $nama == "" && $kelas == "" && $jenis_kelamin == "" && $no_hp == "" && $alamat == "" && $tempat_lahir == "" && $tanggal_lahir == "" && $no_hp == "" && $kategori == "" && $no_peserta == "")
