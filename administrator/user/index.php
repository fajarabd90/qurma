                        ...
                        <div class="col-xl-12">
                            <div class="card flex-fill w-100">
                                <div class="card-header d-flex">
                                    <h5 class="card-title mb-0" style="font-size: 16px;">Daftar User</h5>
                                    <div class="ms-auto d-flex align-items-center">
                                        <button type="button" class="btn btn-primary btn-sm rounded-pill" data-bs-toggle="modal" data-bs-target="#addData" style="margin-right: 5px;">
                                                    ...
                                                    <form method="post" action="insertData.php" id="formTambah">
                                                        ...
                                                        <div class="form-floating mb-2">
                                                            <select class="form-select" id="lembaga" name="lembaga" required>
                                                                <?php $lembaga = query("SELECT * FROM pembayaran ORDER BY lembaga ASC") ?>
                                                                <option selected></option>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#editData').modal({
                ...
                var password = $(event.relatedTarget).closest("tr").find("td:eq(4)").text();
                var role = $(event.relatedTarget).closest("tr").find("td:eq(5)").text();
                var lembaga = $(event.relatedTarget).closest("tr").find("td:eq(6)").text();
                ...
                <!-- Form edit -->
                    <form method="post" class="updateData" action="updateData.php" id="formEdit">
                        ...
                        <div class="form-floating mb-2 password-container">
                            <input type="password" class="form-control" id="passwordEdit" name="password" value="${password}" required>
                            <label for="password">Password</label>
                            <div class="password-toggle" id="togglePasswordEdit" onclick="togglePasswordVisibilityEdit()">
                                <i id="eyeIcon" class='far fa-eye'></i>
                            </div>
                        </div>
