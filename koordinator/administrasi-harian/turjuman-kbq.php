...
<head>
    ...
    <title>Presensi Dan Nilai Turjuman/KBQ | QurMa</title>
...
<body>
    <div class="container">
        ...
        <div class="title">DAFTAR HADIR & PENILAIAN PEMBELAJARAN TURJUMAN METODE UMMI - <?= $lembaga; ?></div>
        ...
        <div class="card-body">
            ...
            <table style="margin-bottom: 5px;">
                <tr class="custom-border">
                    <th style="width: 369px; text-align: left;">Tanggal</th>
                    <td></td>
                    <td></td>
                    <td></td>
                    <td></td>
                ...
                <tr class="custom-border">
                    <th style="width: 352px; text-align: left;">3 Skill/Intisari/KBQ</th>
                    <td></td>
                    <td></td>
                    <td></td>
                    <td></td>
