...
<head>
    ...
    <title>Cetak Form Tajwid Pra Munaqosyah</title>
...
<body>
    <div class="container">
        <div class="title">DAFTAR NILAI TAJWID <br> PRA MUNAQOSAH AL-QUR'AN METODE UMMI <br> <?= $lembaga ?></div>
            ...
            <table class="mb-3">
                <thead>
                    <tr class="custom-border" style="background-color: yellow;">
                        ...
                        <th scope="col" colspan="10">Rincian Nilai</th>
                        <th scope="col" rowspan="3">Total Nilai</th>
                        <th scope="col" rowspan="3">Rata-rata</th>
                    </tr>
                    <tr class="custom-border" style="background-color: yellow;">
                        <th scope="col" colspan="5">Soal Teori</th>
                        <th scope="col" colspan="5">Uraian Ayat</th>
                    </tr>
                    <tr class="custom-border" style="background-color: yellow;">
