...
<head>
    ...
    <title>Cetak Form Juz 30 (Tahfizh 4) Pra Munaqosyah</title>
            ...
            <table class="mb-3">
                <thead>
                    <tr class="custom-border" style="background-color: yellow;">
                        ...
                        <th scope="col">Kls</th>
                        <th scope="col" style="width: 6%;">الانفطار</th>
                        <th scope="col" style="width: 6%;">التكوير</th>
                        <th scope="col" style="width: 6%;">عبس </th>
                        <th scope="col" style="width: 6%;">النازعات</th>
                        <th scope="col" style="width: 6%;">النباء</th>
