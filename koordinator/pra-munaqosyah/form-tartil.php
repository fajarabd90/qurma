...
<head>
    ...
    <title>Cetak Form Tartil Pra Munaqosyah</title>
...
<body>
    <div class="container">
        <div class="title">DAFTAR NILAI TARTIL <br> PRA MUNAQOSAH AL-QUR'AN METODE UMMI <br> <?= $lembaga ?><br></div>
        ...
        <div class="card-body">
            <table class="mb-3">
                <thead>
                    <tr class="custom-border" style="background-color: yellow;">
                        ...
                        <th scope="col" colspan="5">Aspek Penilaian</th>
                        <th scope="col" rowspan="3">Total Nilai</th>
                        <th scope="col" rowspan="3">Rata-rata</th>
                    </tr>
                    <tr class="custom-border" style="background-color: yellow;">
                        <th scope="col">Muroatut Tajwid</th>
                        <th scope="col">Muroatut Kalimah</th>
                        <th scope="col">Kelancaran</th>
                        <th scope="col">Nafs</th>
                        <th scope="col">Waqof</th>
                    </tr>
                    <tr class="custom-border" style="background-color: yellow;">
                        <th scope="col">Max. = 3</th>
                        <th scope="col">Max. = 3</th>
                        <th scope="col">Max. = 2</th>
            ...
            <div style="column-count: 2;">
                <center>
                    ...
                    <p> Jakarta, ............................................... <br><br> Penguji <br><br><br> <u>...................................</u></p>
                </center>
            </div>
