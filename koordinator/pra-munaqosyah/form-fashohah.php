...
<head>
    ...
    <title>Cetak Form Fashohah Pra Munaqosyah</title>
...
<body>
    <div class="container">
        <div class="title">DAFTAR NILAI FASHOHAH <br> PRA MUNAQOSAH AL-QUR'AN METODE UMMI <br> <?= $lembaga ?><br></div>
            ...
            <table class="mb-3">
                <thead>
                    <tr class="custom-border" style="background-color: yellow;">
                        ...
                        <th scope="col" colspan="4">Aspek Penilaian</th>
                        <th scope="col" rowspan="3">Total Nilai</th>
                        <th scope="col" rowspan="3">Rata-rata</th>
                    </tr>
                    <tr class="custom-border" style="background-color: yellow;">
                        <th scope="col">Muroatut Huruf</th>
                        <th scope="col">Muroatut Harokat</th>
                        <th scope="col">Muroatut Sifat</th>
