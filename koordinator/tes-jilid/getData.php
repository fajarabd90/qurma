...
WHERE siswa.lembaga = '$lembaga' AND (tes.nama LIKE '%$searchTerm%' OR tes.guru LIKE '%$searchTerm%' OR tes.keterangan LIKE '%$searchTerm%') AND tes.kategori = 'Tartil' ORDER BY waktu DESC");
?>
